 ...
 */
package edu.kit.datamanager.idoris.metadata.pids.web.api;
 ...
 */
@RestController
@RequestMapping(value = "/api/v1/pid")
...
public interface IPidApi {
    ...
    ResponseEntity<Void> redirectToEntity(
            @Parameter(description = "PID of the entity", required = true)
            @RequestParam(value = "pid", required = false) String pid, WebRequest request);
