...
public class TypeProfileController implements ITypeProfileApi {
    ...
    public ResponseEntity<CollectionModel<EntityModel<TypeProfileDto>>> getAllTypeProfiles() {
    ...
    public ResponseEntity<EntityModel<TypeProfileDto>> getTypeProfile(@SpanAttribute("typeProfile.id") String id) {
    ...
    public ResponseEntity<CollectionModel<String>> getInheritedAttributes(@SpanAttribute("typeProfile.id") @PathVariable String id) {
        ...
        if (dto.isPresent()) {
            ...
            return ResponseEntity.ok(CollectionModel.of(inheritedAttributeIds));
        }
    ...
    public ResponseEntity<EntityModel<TypeProfileDto>> createTypeProfile(TypeProfileDto dto) {
    ...
    public ResponseEntity<EntityModel<TypeProfileDto>> updateTypeProfile(@SpanAttribute("typeProfile.id") String id,
                                                                         TypeProfileDto dto) {
        if (service.get(id).isEmpty()) {
            return ResponseEntity.notFound().build();
        }
    ...
    public ResponseEntity<Void> deleteTypeProfile(@SpanAttribute("typeProfile.id") String id) {
        if (service.get(id).isEmpty()) {
            return ResponseEntity.notFound().build();
        }
        service.delete(id);
    ...
    public ResponseEntity<EntityModel<TypeProfileDto>> patchTypeProfile(@SpanAttribute("typeProfile.id") String id,
                                                                        TypeProfileDto dto) {
        if (service.get(id).isEmpty()) {
            return ResponseEntity.notFound().build();
        }
