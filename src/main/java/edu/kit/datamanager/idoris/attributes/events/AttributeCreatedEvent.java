...
/**
 * Module-scoped Attribute created event carrying AttributeDto payload.
 */
@Getter
@ToString
public class AttributeCreatedEvent extends AbstractDomainEvent {
    @Schema(description = "ID (PID or internalId) of the Attribute")
    private final String id;
    private final AttributeDto payload;

    public AttributeCreatedEvent(String id, AttributeDto payload) {
        this.id = id;
