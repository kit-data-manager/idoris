...
package edu.kit.datamanager.idoris.metadata.users.web.api;
...
public interface IUserApi {
    ...
    ResponseEntity<EntityModel<User>> getUserByORCiD(@PathVariable @Parameter(description = "ORCID identifier string of the User", required = true) String orcidStr);

    /**
     * Gets a User entity by its e-mail address.
     *
     * @param email the e-mail address of the User to retrieve
     * @return the User entity
     */
