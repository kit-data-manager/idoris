...
@Getter
@ToString
public class OperationUpdatedEvent extends AbstractDomainEvent {
    @Schema(description = "ID (PID or internalId) of the Operation")
    private final String id;
    private final Long previousVersion;
    private final OperationResponseDto payload;

    public OperationUpdatedEvent(String id, Long previousVersion, OperationResponseDto payload) {
        this.id = id;
