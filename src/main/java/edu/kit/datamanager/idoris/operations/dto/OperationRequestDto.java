...
/**
 * Request DTO for creating/updating Operations. Contains only client-supplied fields.
 */
@Schema(name = "OperationRequest", description = "Operation request payload")
public record OperationRequestDto(
    ...
    // JavaBean-style accessors for frameworks that require them
