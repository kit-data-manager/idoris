...
@Rule(
        ...
        dependsOn = AttributeSyntaxValidator.class
)
public class AttributeInheritanceValidator extends ValidationVisitor {

    private final IDataTypeService dataTypeService;

    public AttributeInheritanceValidator(IDataTypeService dataTypeService) {
        super();
