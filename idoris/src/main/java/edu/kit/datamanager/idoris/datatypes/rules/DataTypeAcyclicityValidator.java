...
@Rule(
        ...
        dependsOn = DataTypeSyntaxValidator.class
)
public class DataTypeAcyclicityValidator extends ValidationVisitor {
    private final Neo4jClient neo4jClient;

    public DataTypeAcyclicityValidator(Neo4jClient neo4jClient) {
