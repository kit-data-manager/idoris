 ...
 */
package edu.kit.datamanager.idoris.pids.dao;
...
public interface IPersistentIdentifierDao extends Neo4jRepository<PIDNode, PID>, PagingAndSortingRepository<PIDNode, PID> {
     ...
     */
    @Query("MATCH (p:PIDNode)-[:IDENTIFIES]->(e) WHERE e.internalId = $entityInternalId RETURN p.pid")
    List<PID> findPidsByEntityInternalId(@Param("entityInternalId") String internalId);
}
